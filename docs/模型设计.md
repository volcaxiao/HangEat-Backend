...
#### 得到餐馆数目 get-restaurant-num [get]

- 可选参数：creator_id

#### 得到餐馆列表 get-restaurant-list?from=&to= [get]
...
#### 得到tag下的餐馆数量 get-restaurant-num-by-tag?tags=&tags=... [get]

#### 得到tag下的餐馆列表 get-restaurant-list-by-tag?from=&to=&tags=tag1,tag2... [get]
